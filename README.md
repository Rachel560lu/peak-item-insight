...
![Settings entry in the pause menu](docs/assets/settings-entry.png)
...
![Independent item text and stamina preview settings](docs/assets/settings-panel.png)
...
![物品文字和精力条独立设置](docs/assets/settings-panel.png)
