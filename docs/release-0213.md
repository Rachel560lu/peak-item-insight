...
GitHub v0.2.13 published: https://github.com/Rachel560lu/peak-item-insight/releases/tag/v0.2.13. The publicly readable release asset digest matches the validated ZIP. Thunderstore v0.2.13 published: https://thunderstore.io/c/peak/p/Rachel560lu/PeakItemInsight/v/0.2.13/. The version page and API confirm the active 0.2.13 release and latest version. The downloaded Thunderstore ZIP is byte-identical to the validated GitHub release ZIP. Existing PEAK categories and non-NSFW listing settings were preserved.
